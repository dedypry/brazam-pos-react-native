...
const inputStyle = tva({
  ...
  variants: {
    ...
    variant: {
      paded:
        "border-none bg-secondary-200 rounded-md data-[invalid=true]:bg-error-50 data-[invalid=true]:hover:bg-error-50 data-[invalid=true]:data-[focus=true]:bg-error-50 data-[invalid=true]:data-[focus=true]:hover:bg-error-50 data-[invalid=true]:data-[disabled=true]:hover:bg-error-50",
      underlined:
